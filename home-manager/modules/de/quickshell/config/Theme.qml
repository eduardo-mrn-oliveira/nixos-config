...
FileView {
	path: Quickshell.env("YVANISHER_QS_THEME") ?? ""
	...
	JsonAdapter {
		...
		property string fontSansSerif: "Noto Sans"
		property string fontSerif: "Noto Serif"
		property string fontEmoji: "Noto Color Emoji"
